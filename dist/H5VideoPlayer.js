  ...
  H5VideoPlayer.prototype._assignWrapperStyle = function _assignWrapperStyle() {
    ...
    var containerRect = function containerRect() {
      return _this2.container.getBoundingClientRect();
        ...
        orientationchangeEvt = "onorientationchange" in window ? "orientationchange" : "resize",
      ...
      window.removeEventListener(orientationchangeEvt, function () {
        return _changeOrientation();
      }, false);

      setTimeout(function () {
        _changeStyle();
        window.addEventListener(orientationchangeEvt, function () {
          return _changeOrientation();
        }, false);
      }, 500);
    };
...
// module
exports.push([module.i, ".src-style__container, .src-style__video, .src-style__mask, .src-style__playButtonWrapper, .src-style__wrapper, .src-style__videoWrapperForConstraintRatio {\n  position: absolute;\n}\n\n.src-style__container, .src-style__video, .src-style__mask, .src-style__playButtonWrapper {\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n}\n\n.src-style__wrapper, .src-style__videoWrapperForConstraintRatio {\n  left: -100%;\n  top: -100%;\n  right: -100%;\n  bottom: -100%;\n  margin: auto;\n}\n\n.src-style__container {\n  z-index: 9999;\n  overflow: hidden;\n}\n\n.src-style__wrapper {\n  z-index: 1;\n  overflow: hidden;\n  background-color: black;\n  transform-origin: 50% 50%;\n}\n\n.src-style__videoWrapperForConstraintRatio {\n  z-index: 1;\n  overflow: hidden;\n}\n\n.src-style__video {\n  z-index: -1;\n  object-fit: fill;\n  object-position: 50% 50%;\n}\n\n.src-style__mask {\n  z-index: 10;\n}\n\n.src-style__playButtonWrapper {\n  z-index: 100;\n  background-color: rgba(0, 0, 0, 0.1);\n}\n", ""]);
